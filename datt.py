a=[{'eid':1,'ename':'Nixie','email':'nmacquist0@walmart.com','gender':'Female'},
...
# print(m)
    # elif a[c]['gender']=='Female':
    #     f+=1
    # else:
    #     n_b+=1
    #     c+=1
# print('Male',m,'Female',f,'Non-binary',n_b)



# m=[i['ename'] for i in filter(lambda x:x['ename'][0]=='A',a)]
# print(*m)
